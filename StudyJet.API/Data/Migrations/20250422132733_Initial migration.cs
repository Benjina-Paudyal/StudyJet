...
namespace StudyJet.API.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedToChangePassword = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUpdates", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CourseUpdates_Courses_CourseID",
                        column: x => x.CourseID,
                        principalTable: "Courses",
                        principalColumn: "CourseID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPurchaseCourse", x => x.ID);
                    table.ForeignKey(
                        name: "FK_UserPurchaseCourse_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPurchaseCourse_Courses_CourseID",
                        column: x => x.CourseID,
                        principalTable: "Courses",
                        principalColumn: "CourseID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseUpdates_CourseID",
                table: "CourseUpdates",
                column: "CourseID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPurchaseCourse_CourseID",
                table: "UserPurchaseCourse",
                column: "CourseID");

            migrationBuilder.CreateIndex(
                name: "IX_UserPurchaseCourse_UserID_CourseID",
                table: "UserPurchaseCourse",
                columns: new[] { "UserID", "CourseID" },
                unique: true);
